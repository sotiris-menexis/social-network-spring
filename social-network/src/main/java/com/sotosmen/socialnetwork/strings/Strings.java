...
public class Strings {
	...
	public static final String friendS = "Friend was added successfully";
	...
	public static final String noMessagesContent = "Message is null";
	public static final String exConversation = "Conversation already exists";
	...
	public static final String noVotesFound = "No votes exist";
	public static final String exVote = "Vote already exists";
	public static final String noFriendRequests = "No Friend Requests exist";
	public static final String noFriendRequestsUser = "No Friend Requests exist for user";
	public static final String exFriendRequest = "Friend Request already exists";
	public static final String noFriends = "No Friends exist";
	public static final String noFriendsUser = "No Friends for this User exist";
	public static final String exFriend = "This friend already exists";
}
